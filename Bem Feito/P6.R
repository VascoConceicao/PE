...
amostras <- matrix(rexp(n * simulacoes, rate = 1/a), nrow = n)  # gerar amostras
valores_simulados <- colSums(amostras)  # calcular a duração total para cada amostra
...
cat("Diferença absoluta em porcentagem:", diferenca, "%")
