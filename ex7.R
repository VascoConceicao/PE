...
# Calculate the probability quantile p = 0.75 using the estimated theta
quantile_estimate <- a * (1 - 0.75)^(-1/theta_estimate)
cat("Estimated Quantile for p = 0.75:", quantile_estimate, "\n")

# True quantile when theta = 3.6
true_quantile <- a * (1 - 0.75)^(-1/3.6)
cat("True Quantile for theta=3.6:", true_quantile, "\n")
...
cat("Absolute Deviation:", round(absolute_deviation, 4), "\n")
